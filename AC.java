...
class AC {
    ...
    AC(int id) {
        ...
        // pass the static ID as an argument so that it can Assign the ids to Accounts
        // in Ascending order.
        // suppose for the first Account ID will be 1 then rest will be Assigned as
        // 2,3,4,5....
    }
    ...
    public static void printID() {
        ...
        // for id=1 --> %3d will left 2 spaces and print 1 at the end and %03d will fill
        // those blank spaces with 0
        ID++;
    }
    ...
    public void moneyTransfer(ArrayList<AC> l) {
        // here money will be transferred to one account to another so pass whole
        // arraylist as argument so it can get both the required ids...one for taking
        // money and one for transferring money.
        double money;
        int id;
        Scanner sc = new Scanner(System.in);
    ...
    public void createAccount(ArrayList<AC> a) {
        // new account will be added in the Arraylist so pass it as the argument and add
        // new object of AC class using add function.
        a.add(new AC(ID));
        AC.printID();
    }
